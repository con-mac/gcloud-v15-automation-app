...
$possiblePaths = @(
    "$projectRoot\frontend",             # From scripts -> project root/frontend (PREFERRED - main project structure)
    "$deploymentDir\..\frontend",        # From deployment package -> root/frontend
    "$scriptDir\..\..\frontend",        # From scripts -> root/frontend (alternative)
    "$scriptDir\..\frontend",           # From scripts -> deployment/frontend
